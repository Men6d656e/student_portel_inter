...
export default function ResultsPage() {
  ...
  const { data: user } = trpc.result.getMe.useQuery();
      ...
      <Card className="border-none shadow-xl bg-card/50 backdrop-blur-sm overflow-hidden">
        ...
        <CardContent>
          <Tabs value={resultTypeFilter} onValueChange={handleTabChange}>
            <div className="flex sm:justify-between pb-5">
              <TabsList>
            ...
            <TabsContent value={resultTypeFilter} className="space-y-4">
              {isLoading ? (
                ...
                <>
                  ...
                  {/* Pagination */}
                  <div className="flex items-center sm:justify-end justify-center space-x-2 py-4 mt-5">
                    <Button
                      variant="outline"
                      size="sm"
      ...
      >
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Are you sure you want to delete this result? This will also delete
              all associated student marks. This action cannot be undone.
            </DialogDescription>
          </DialogHeader>
          <div className="flex justify-end gap-2">
